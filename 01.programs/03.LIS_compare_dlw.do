...
Modification Date:  7/18/2023 (MV) 
Do-file version:    01
References:          
Output:             
==================================================*/
...
frame repo {	
	...
	local the9      = "AUS|CAN|ISR|JPN|KOR|TWN|USA|DEU|GBR"
	local preeusilc = "AUT|BEL|CZE|DNK|FIN|FRA|GRC|HUN|ISL|IRL|ITA|LUX|NLD|NOR|POL|ROU|SVK|SVN|ESP|SWE|CHE"
	gen to_keep = .
